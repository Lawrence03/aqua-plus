...
import icu.samnyan.aqua.sega.mai2.handler.impl.GetUserPreviewHandler;
...
@Component("CardmakerMaiCMGetUserPreviewHandler")
public class MaiCMGetUserPreviewHandler implements BaseHandler {
    ...
    @Autowired
    public MaiCMGetUserPreviewHandler(BasicMapper mapper, UserDataRepository userDataRepository, UserOptionRepository userOptionRepository) {
        this.mapper = mapper;
