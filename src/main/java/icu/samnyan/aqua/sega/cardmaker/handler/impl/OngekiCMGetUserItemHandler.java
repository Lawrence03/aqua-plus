...
@Component("CardmakerOngekiCMGetUserItemApi")
public class OngekiCMGetUserItemHandler implements BaseHandler {
    private static final Logger logger = LoggerFactory.getLogger(OngekiCMGetUserItemHandler.class);
    private final BasicMapper mapper;

    private final UserItemRepository userItemRepository;

    @Autowired
    public OngekiCMGetUserItemHandler(BasicMapper mapper, UserItemRepository userItemRepository) {
        this.mapper = mapper;
