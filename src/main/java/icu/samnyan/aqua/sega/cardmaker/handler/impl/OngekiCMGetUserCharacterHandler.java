...
@Component("CardmakerOngekiCMGetUserCharacterHandler")
public class OngekiCMGetUserCharacterHandler implements BaseHandler {
    private static final Logger logger = LoggerFactory.getLogger(OngekiCMGetUserCharacterHandler.class);
    private final BasicMapper mapper;

    private final UserCharacterRepository userCharacterRepository;
    @Autowired
    public OngekiCMGetUserCharacterHandler(BasicMapper mapper, UserCharacterRepository userCharacterRepository) {
        this.mapper = mapper;
