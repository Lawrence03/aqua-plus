 ...
 */
@Component("C3GetUserDuelHandler")
public class GetUserDuelHandler implements BaseHandler {
    ...
    @Autowired
    public GetUserDuelHandler(StringMapper mapper, UserDuelRepository userDuelRepository) {
        this.mapper = mapper;
    ...
    public String handle(Map<String, Object> request) throws JsonProcessingException {
        ...
        List<UserDuel> userDuelList = userDuelRepository.findByUser_Card_ExtId(Long.parseLong(userId));
