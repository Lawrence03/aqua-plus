...
public class MaimaiServletController {
    ...
    @RequestMapping("oldapi/ping")
    public String oldApiPing() {
        return "ok";
    }

    @RequestMapping("oldapi/userdata180/**")
    public String oldApiUserData180() {
        return "{}";
    }

    @RequestMapping("oldapi/friend/**")
    public String oldApiFriend() {
        return "{}";
    }
